...
#     result = Triangles.type(5, 5, 5)

#     assert_equal "equilateral", result
#   end

#   def test_type_isosceles
#     result = Triangles.type(3, 3, 4)

#     assert_equal "isosceles", result
#   end

#   def test_type_scalene
#     result = Triangles.type(3, 4, 5)

#     assert_equal "scalene", result
#   end

#   def test_raises_zero_argument
#     assert_raises(ArgumentError) { Triangles.type(0, 4, 5) }
#   end

#   def test_raises_negative_argument
#     assert_raises(ArgumentError) { Triangles.type(-3, 4, 5) }
#   end

#   def test_raises_degenerate_case
#     assert_raises(ArgumentError) { Triangles.type(1, 1, 2) }
#   end
# end
